...
const HomePage = () => {
  return (
    <div className="home-links">
      ...
      <Link to="/draw">
        <img src="https://lh3.googleusercontent.com/drive-viewer/AEYmBYSp_slmcz8IEt3o0-c-KodyN_jsIpXGBhOhNj81boh9gG0v8fdKAQhLb0AcjabtxT-Mm0emaqqScCFtj-4lE6h18iDdUQ=s2560" alt="Drawing" className="home-image" />
